...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="active"><a href="/acoes?pg=1&limit=20"><i class="fa fa-envelope"></i> <span>Ações</span></a></li>
      <li><a href="/notas?pg=1&limit=20"><i class="fa fa-envelope"></i> <span>Notas Compra</span></a></li>
